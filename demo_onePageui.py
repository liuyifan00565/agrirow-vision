...
class OrthophotoApp(QMainWindow):
    def __init__(self):
        ...
        self.clientio.video_client.connect_video_displayer(self.update_frame) #显示后端传回来的视频流
        self.clientio.video_client.connect_plotter(self.plot_bias)        #绘制曲线
    ...
    def update_frame(self, frame):
        ...
        cpframe = frame.copy()
        # print("cpframe.shape=",cpframe.shape)
        img = QtGui.QImage(cpframe.data, cpframe.shape[1], cpframe.shape[0], QtGui.QImage.Format_RGB888)

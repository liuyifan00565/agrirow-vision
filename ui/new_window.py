...
class MyWindow(QWidget):
    ...
    def __init__(self, parent=None,
        ...
        self.clientio.video_client.connect_video_displayer(self.display_image_1) #显示后端传回来的视频流
        self.clientio.video_client.connect_plotter(self.plot_from_thread)        #绘制曲线
        # self.clientio.video_client.do_connect( 
        #     lambda: (
        #         self.clientio.video_client.image_data.connect(self.display_image_1),  #显示后端传回来的视频流
        #         self.clientio.video_client.plot_signal.connect(self.plot_from_thread) #绘制曲线
        #     )
        # )
        self.seq = 0
    ...
    def unit_ui(self):
        ...
        self.ui.set_system_name("行间除草系统主界面")
        ...
        # self.camera_thread1.image_data.connect(self.display_image_1) #显示后端传回来的视频流
        ...
        # self.camera_thread1.plot_signal.connect(self.plot_from_thread) #绘制曲线
    ...
    # 这四个函数最后会捏成一块儿，方便维护
    # todo
    def display_image_1(self, pred):
        # frame_path=f'C:\\Users\\admin\\Desktop\\biaoding\\zonghe\\{self.seq}.jpg'
        # cv2.imwrite(frame_path, pred)

        img = QtGui.QImage(pred.data, pred.shape[1], pred.shape[0], QtGui.QImage.Format_RGB888)
        self.seq = self.seq +1
